...
- screenshot review through `/work/remote_tools` for browser or 1C tasks

For `/work/remote_tools` GUI tasks:
...
- For 1C tasks, do not leave a session open and do not create or leave posted
